  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tutorial as @tutorial" do
        ...
        post :create, {:tutorial => { "topic_id" => "invalid value" }}, valid_session
        assigns(:tutorial).should be_a_new(Tutorial)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tutorial" do
        ...
        Tutorial.any_instance.should_receive(:update_attributes).with({ "topic_id" => "MyString" })
        put :update, {:id => tutorial.to_param, :tutorial => { "topic_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tutorial as @tutorial" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tutorial.any_instance.stub(:save).and_return(false)
        put :update, {:id => tutorial.to_param, :tutorial => { "topic_id" => "invalid value" }}, valid_session
        assigns(:tutorial).should eq(tutorial)
      end
